...
from ..resources.managers.eos_development_manager import AsyncEOSDevelopmentManager
...
class AsyncClient(BaseClient):
    ...
    @cached_property
    def eos(self) -> AsyncEOSDevelopmentManager:
        return AsyncEOSDevelopmentManager(self)
